...
export default function ResetPasswordForm({ accessToken, refreshToken }: ResetPasswordFormProps) {
  ...
  const handleSubmit = async (e: FormEvent) => {
    ...
    // Reset messages
    const newErrors: ResetPasswordFormState["errors"] = {};
    ...
    try {
      ...
      setFormState({
        ...formState,
        isSubmitting: false,
        successMessage: "Hasło zostało zmienione! Za chwilę zostaniesz przekierowany do strony logowania.",
      });
      ...
      setFormState({
        ...
        isSubmitting: false,
        errors: {
          general: "Wystąpił błąd podczas resetowania hasła. Spróbuj ponownie później.",
        },
      });
    }
  };
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-6">
      ...
      <Button type="submit" disabled={formState.isSubmitting} className="w-full" size="lg">
        {formState.isSubmitting ? "Ustawianie hasła..." : "Ustaw nowe hasło"}
      </Button>
    </form>
  );
}
